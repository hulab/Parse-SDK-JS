        ...
        return _regenerator.default.async(function (_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _regenerator.default.awrap(Promise.all([query.find(findOptions), Promise.resolve(callback(previousResults))]));
      ...
      return _regenerator.default.async(function (_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 6:
              liveQueryClient = _context6.sent;
              ...
              return _context6.abrupt("return", subscription.subscribePromise.then(function () {
                return subscription;
              }));
